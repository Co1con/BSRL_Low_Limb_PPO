...
class JointHopf:
    ...
    def __init__(
        ...
        coeffs = torch.tensor(
            [
                [-0.000131372749080, 0.289522948487],
                [0.256836973910, -0.0842999265852],
                [-0.116785984675, -0.375254873344],
                [-0.0358588005803, -0.164553153064],
                [-0.00799305104262, 0.0956071902501],
                [0.00133689063208, 0.00495501442061],
                [0.0109332404127, 0.0275568280953],
            ],
            device=self.device,
            dtype=self.dtype,
        )
